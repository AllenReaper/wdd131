...
const ages = [25, 55, 12, 7];

console.log(ages.sort());

function sortages(a, b, c, d){
    return -1;
    return 0;
    return 1;
    return 2;
...
const people = [{name: "Jax"},{name:"Hunter"},{name:"blake"}];

console.log(people.sort());

function sortpeople(a, b, c){
...
function search() {
    ...
    let filteredHikes = hikes.filter(function(hike){
        return ( 
            ...
            hike.distance.toLowerCase().includes(hikeQuery.toLowerCase()) ||
